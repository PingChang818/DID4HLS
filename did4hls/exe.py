    ...
    for it in range(config["n_it"]):
        ...
        while True:
            ...
            for epoch in tqdm_gatl:
                ...
                if min_loss > avg_loss:
                    min_loss = avg_loss
                    torch.save(gatl.state_dict(), "save/gatl_" + str(it) + ".pth")
            ...
            if min_loss > 0.1:
                ...
                gatl.load_state_dict(torch.load("save/gatl_" + str(it) + ".pth"))
                break
        ...
        while True:
            ...
            for epoch in tqdm_gata:
                ...
                if min_loss > avg_loss:
                    min_loss = avg_loss
                    torch.save(gata.state_dict(), "save/gata_" + str(it) + ".pth")
            ...
            if min_loss > 0.1:
                ...
                print("min_loss = {:.4e}".format(min_loss))
                gata.load_state_dict(torch.load("save/gata_" + str(it) + ".pth"))
                break
