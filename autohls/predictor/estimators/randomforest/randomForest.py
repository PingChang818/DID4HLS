        ...
        for t in enumerate(space):
            if t[1] == "function":
                ...
                for i, itf in enumerate(space[t[1]]):
                    ptype.append("interface&" + itf + "&block")
                    ptype.append("interface&" + itf + "&cyclic")
            ...
            for p in enumerate(pragma):
                if p[1] == "inline":
                    ...
                    for itf in enumerate(pragma[p[1]]):
                        feature[self.ptype.index("interface&" + itf[1] + "&" + pragma[p[1]][itf[1]][0])] = pragma[p[1]][itf[1]][1]
